#-*- coding: utf-8 -*-
'''
src.api.speechFromText -- watson assistant with discovery
...
from src import textToSpeechUser, textToSpeechPassword, textToSpeechIAMKey, textToSpeechUrl, language_identify
